...
class Calculator extends JFrame {
    ...
    private void sendMenuBar() {
        ...
        view.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "There are no help topics to view.","Calculator", JOptionPane.OK_CANCEL_OPTION);
            }
        });
        ...
        about.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "About Calculator","Calculator", JOptionPane.OK_CANCEL_OPTION);
    ...
    private void sendDisplay() {
        ...
        display.applyComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
        display.setText("0");
        display.setFont(new Font("Arial", Font.PLAIN, 39));
        add(display);
